...
public class SceneReference : ISerializationCallbackReceiver
{
    ...
    public string RawScenePath => scenePath;
...
//this is because editor code is stripped on build
#pragma warning disable CS0162
    public override bool Equals(object obj)
	{
        if (obj is not SceneReference otherSceneRef)
            return false;

#if UNITY_EDITOR
        return sceneAsset == otherSceneRef.sceneAsset;
#endif
        return scenePath == otherSceneRef.scenePath;
    }

	public override int GetHashCode()
	{
#if UNITY_EDITOR
        return sceneAsset ? sceneAsset.GetHashCode() : 0;
#endif
...
#pragma warning restore
    ...
    {
        return sceneAsset == null ? string.Empty : scenePath = AssetDatabase.GetAssetPath(sceneAsset);
    }
...
public class SceneReferencePropertyDrawer : PropertyDrawer
{
    ...
    private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
    {
        ...
        {
            iconContent = EditorGUIUtility.IconContent("d_Invalid@2x");
        ...
        {
            iconContent = EditorGUIUtility.IconContent("d_GreenCheckmark@2x");
        ...
        {
            iconContent = EditorGUIUtility.IconContent("d_False@2x");
            labelContent.text = "BuildIndex: " + buildScene.buildIndex;
